...
if($_POST['key']=="Mobin.7060.mobin.ali.$#@!"){
    ...
    if($_POST['action']=="ringON"){
        ...
        sendToNotificationUsers("درب خانه توسط ".whichUser($_POST['whichUser'])." باز شد.");
    ...
    else if($_POST['action']=="sshLogin"){
        sendToNotificationUsers("یکی با آی پی ".$_POST['ip']." به سرور ssh کرد.");
        //sendMessageToAll("دستگاه آماده به کار است!! خیالت راحت باشه.");
    }
}
